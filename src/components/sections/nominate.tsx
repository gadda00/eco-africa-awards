...
export function NominateSection() {
    ...
    return (
      <section id="nominate" className="relative py-24 lg:py-32 bg-background">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl border border-emerald-500/40 bg-gradient-to-br from-emerald-500/15 via-card/60 to-amber-500/10 p-8 lg:p-12 text-center">
              ...
              <div className="relative">
                ...
                <div className="mt-6 inline-flex flex-col items-center gap-1 px-6 py-3 rounded-xl border border-emerald-500/30 bg-emerald-500/10">
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-1/4 h-72 w-72 rounded-full bg-emerald-500/8 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 h-72 w-72 rounded-full bg-amber-500/8 blur-3xl pointer-events-none" />
        ...
        <SectionHeading
          ...
          title={
            <>
              ...
              <span className="text-gradient-emerald">climate leader.</span>
            </>
          }
        ...
        <Reveal delay={0.1}>
          <div className="mt-12 relative overflow-hidden rounded-3xl border border-border/60 bg-card/50 backdrop-blur-xl">
            ...
            <div className="relative px-6 lg:px-10 pt-7 pb-2 border-b border-border/60">
                    ...
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div
                        className={cn(
                          ...
                          i === step && "bg-gradient-to-br from-emerald-500 to-emerald-600 text-background shadow-lg shadow-emerald-500/30",
              ...
              <div className="mt-5">
                <Progress value={progress} className="h-1.5 bg-muted/60 [&>div]:bg-gradient-to-r [&>div]:from-emerald-500 [&>div]:to-amber-500" />
              </div>
            </div>
                ...
                >
                  ...
                  {step === 3 && (
                    <div className="space-y-5">
                      ...
                      {/* AI Assistant */}
                      <div className="mt-6 rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-card/40 to-emerald-500/10 p-5">
                        <div className="flex items-center justify-between gap-3 flex-wrap">
                          <div className="flex items-center gap-2">
                            <div className="h-9 w-9 rounded-lg bg-amber-500/20 ring-1 ring-amber-500/40 grid place-items-center">
                        ...
                        {aiFeedback.result && (
                          ...
                          >
                            <div className="text-xs text-amber-200 italic leading-relaxed">
              ...
              <div className="mt-8 pt-6 border-t border-border/60 flex items-center justify-between">
                ...
                {step < STEPS.length - 1 ? (
                  ...
                  <Button
                    type="submit"
                    disabled={submitting}
                    className="bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-background font-semibold min-w-44"
                  >
                    {submitting ? (
