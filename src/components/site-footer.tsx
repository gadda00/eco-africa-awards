...
import { Mail, Phone, MapPin, Twitter, Linkedin, Youtube, Instagram, ArrowUpRight, Loader2, CheckCircle2 } from "lucide-react";
...
export function SiteFooter() {
  ...
  const subscribe = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setDone(true);
      toast.success("You're subscribed! Welcome to the Africa Climate Leadership community.");
      setEmail("");
    } catch (e: any) {
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            {done ? (
              <div className="flex items-center gap-2 p-3 rounded-xl bg-cream/10 border border-cream/20 text-sm text-cream">
                <CheckCircle2 className="h-4 w-4 text-gold-light flex-shrink-0" />
              ...
              <form onSubmit={subscribe} className="space-y-2">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-gold to-terracotta hover:from-gold-light hover:to-terracotta text-cream font-semibold h-10"
                >
                  {loading ? (
